...
from dataqualy.audit.domain import AuditRun, CaptureOptions, ConnectionProfile, Manifest, Snapshot
from dataqualy.audit.engines import ENGINES
from dataqualy.audit.mapping import validate_manifest
from dataqualy.audit.orchestration import Project
from dataqualy.audit.storage import save
...
def default_project_directory() -> Path:
    ...
    return Path(base or Path.home() / '.dataquality') / 'projects' / 'audit-project'
...
class AppViewModel(QObject):
    ...
    def __init__(self, *, demo: bool = False, directory: str = '',
        ...
        self._settings = settings if settings is not None else QSettings('DataQuality', 'Desktop')
        ...
        self._temp = TemporaryDirectory(prefix='dataquality-demo-') if demo else None
        ...
        self._key_env = 'DATAQUALY_EVIDENCE_KEY'
    ...
    def _reset_project_context(self, directory: Path) -> None:
        ...
        try:
            ...
            self._key_env, self._page = 'DATAQUALY_EVIDENCE_KEY', 0
