...
from dataqualy import __version__
...
<meta name="viewport" content="width=device-width,initial-scale=1"><title>DataQuality — auditoria</title>
...
<h1>DataQuality — {e(run.status)}</h1><p>{e(explanation)}</p>
<p>Execução: {e(run.run_id)} · DataQuality {e(__version__)} · formato snapshot/manifesto: 1</p>
